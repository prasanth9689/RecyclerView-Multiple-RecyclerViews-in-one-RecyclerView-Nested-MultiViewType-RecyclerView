package com.skyblue.recyclerview_multiple
...
import com.skyblue.recyclerview_multiple.databinding.BannerItemBinding
import com.skyblue.recyclerview_multiple.databinding.ItemsBinding
...
class MainAdapter(private val dataItemList: List<DataItem>) :
    ...
    inner class RecyclerItemViewHolder(private val binding: ItemsBinding) :
        RecyclerView.ViewHolder(binding.root) {
